...
* [MassGrave.](https://massgrave.dev) Да, он указан в самом верху списка в активации винды, но помимо этого там есть: ссылки на чистые установщики Office и Windows, активатор IDM, FAQ по активации винды этим скриптом и т.д.
